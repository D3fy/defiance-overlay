...
SLOT="0"
IUSE="dbi debug doc extras jemalloc kerberos mysql oracle postgres relp snmp ssl static-libs zeromq zlib"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-8.4.0-c99.patch
	eautoreconf
}
src_configure() {
	# Maintainer notes:
